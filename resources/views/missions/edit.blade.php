            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="container">
                        ...
                        <h2>Modification d'une nouvel misson:</h2><br />
                        ...
                        <form method="post" action="{{action('MissionController@update', $id)}}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" name='NOM' value="{{$mission->NOM1}}">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="date" class="form-control" name='DATE_MISSION' value="{{$mission->DATE_MISSION}}">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="ID_PERS" class="form-control">
                                        ...
                                        <option value="{{$ID_PERSE['NOM']}}"> {{$ID_PERSE['NOM']}} </option>                                        
                                        @endforeach
